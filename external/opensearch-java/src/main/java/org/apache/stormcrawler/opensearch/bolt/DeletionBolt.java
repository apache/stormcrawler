...
public class DeletionBolt extends BaseRichBolt implements AsyncBulkProcessor.Listener {
    ...
    /**
     * Get the document id. Uses the value found in the metadata for the key configured with {@link
     * AbstractIndexerBolt#DOC_ID_METADATA_PARAM_NAME} if present, so that the ID matches the one
     * generated by the indexer for the same document.
     *
     * @param metadata The {@link Metadata}.
     * @param url The normalised url.
     * @return Return the value found in the metadata, or the normalised url SHA-256 digest as
     *     String.
     */
